    ...
    def hanga_hupo(self):
        ...
        while True:
            try:
                ...
                get_stuff = urllib.request.urlopen(request)
                break
                ...
                if count > 8:
                    ...
                    try:
                        ...
                        request = urllib.request.Request(alternative_url, headers=headers)
                        get_stuff = urllib.request.urlopen(request)
        ...
        while True:
            try:
                ...
                self.metasoup = get_soup_from_url(meta_url).table
                break
            except:
                time.sleep(3)
...
# Code had a non existent clean_whitespace function
