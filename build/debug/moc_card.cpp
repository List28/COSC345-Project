...
#include "../../qtGuiApplication/card.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSCardENDCLASS_t qt_meta_stringdata_CLASSCardENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(5, 19),  // "expandButtonClicked"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 2),  // "MP"
        QT_MOC_LITERAL(29, 2),  // "mp"
        QT_MOC_LITERAL(32, 23)   // "on_expandButton_clicked"
    },
    "Card",
    "expandButtonClicked",
    "",
...
void Card::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->expandButtonClicked((*reinterpret_cast< std::add_pointer_t<MP>>(_a[1]))); break;
        case 1: _t->on_expandButton_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Card::*)(MP );
            if (_t _q_method = &Card::expandButtonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Card::expandButtonClicked(MP _t1)
{
